...
const naiade = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'courant', name: 'Courant Vif', cost: 1, desc: 'Inflige 3 dégâts.', effects: [dmg(3)] },
            { id: 'lame_eau', name: 'Lame d\'Eau', cost: 2, desc: 'Inflige 4 dégâts.', effects: [dmg(4)] },
        ],
        utility: {
            id: 'lustrale', name: 'Eau Lustrale', cost: 1,
...
const triton = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'trident', name: 'Trident du Héraut', cost: 1, desc: 'Inflige 3 dégâts.', effects: [dmg(3)] },
            { id: 'souffle', name: 'Souffle Assourdissant', cost: 3, desc: 'Étourdit un ennemi 1 tour.', effects: [status('stun', 1, 'enemy_god', 1)] },
        ],
        utility: {
            id: 'ecume', name: 'Voile d\'Écume', cost: 1,
...
const charybde = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'engloutir', name: 'Engloutir', cost: 2, desc: '4 dégâts et meule 2 cartes.', effects: [dmg(4), mill(2)] },
            { id: 'succion', name: 'Succion Abyssale', cost: 3, desc: '3 dégâts à tous les ennemis.', effects: [dmg(3, 'all_enemies')] },
        ],
        utility: {
            id: 'reflux', name: 'Reflux', cost: 1,
            desc: 'Se soigne de 4.',
            effects: [heal(4, 'self')],
        },
    },
...
const ceto = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'crocs', name: 'Crocs de Céto', cost: 2, desc: '3 dégâts et 2 saignements.', effects: [dmg(3), status('bleed', 2, 'same')] },
            { id: 'ecrasement', name: 'Écrasement', cost: 3, desc: 'Inflige 6 dégâts.', effects: [dmg(6)] },
        ],
        utility: {
            id: 'defi', name: 'Défi des Profondeurs', cost: 2,
            desc: 'Provocation sur soi 2 tours et bouclier 5.',
            effects: [status('provocation', 1, 'self', 2), shield(5)],
        },
    },
);
