...
const eros = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'trait', name: 'Trait de Plomb', cost: 1, desc: 'Inflige 3 dégâts.', effects: [dmg(3)] },
            { id: 'passion', name: 'Passion Brûlante', cost: 2, desc: '2 dégâts et 2 saignements.', effects: [dmg(2), status('bleed', 2, 'same')] },
        ],
        utility: {
            id: 'fleche', name: 'Flèche du Désir', cost: 3,
            desc: 'Étourdit un ennemi 1 tour.',
...
const charite = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'eclat', name: 'Éclat Aveuglant', cost: 1, desc: 'Inflige 3 dégâts.', effects: [dmg(3)] },
            { id: 'seduction', name: 'Séduction', cost: 2, desc: 'Inflige 4 dégâts.', effects: [dmg(4)] },
        ],
        utility: {
            id: 'danse', name: 'Danse des Grâces', cost: 2,
            desc: 'Soigne tous les alliés de 2 et retire leur poison.',
            effects: [heal(2, 'all_allies'), cleanse('poison')],
        },
    },
);
...
const sirene = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'naufrage', name: 'Naufrage', cost: 2, desc: '3 dégâts et l\'adversaire défausse 1 carte.', effects: [dmg(3), discard(1)] },
            { id: 'recifs', name: 'Récifs', cost: 3, desc: '3 dégâts à tous les ennemis.', effects: [dmg(3, 'all_enemies')] },
        ],
        utility: {
            id: 'chant', name: 'Chant Envoûtant', cost: 3,
            desc: 'Étourdit un ennemi 1 tour.',
            effects: [status('stun', 1, 'enemy_god', 1)],
        },
    },
...
const adonis = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'epieu', name: 'Épieu de Chasse', cost: 2, desc: 'Inflige 5 dégâts.', effects: [dmg(5)] },
            { id: 'anemone', name: 'Anémone de Sang', cost: 1, desc: '2 dégâts et 1 saignement.', effects: [dmg(2), status('bleed', 1, 'same')] },
        ],
        utility: {
            id: 'faveur', name: 'Faveur des Déesses', cost: 2,
            desc: 'Se soigne de 4, régénération 2 et provocation sur soi.',
            effects: [heal(4, 'self'), status('regen', 2, 'self', 3), status('provocation', 1, 'self', 2)],
        },
    },
);
