...
const oneiros = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'songe', name: 'Songe Profond', cost: 3, desc: 'Étourdit un ennemi 1 tour.', effects: [status('stun', 1, 'enemy_god', 1)] },
            { id: 'cauchemar', name: 'Cauchemar', cost: 2, desc: '2 dégâts et meule 2 cartes.', effects: [dmg(2), mill(2)] },
        ],
        utility: {
            id: 'murmure', name: 'Murmure Endormant', cost: 1,
            desc: 'Inflige 3 dégâts.',
            effects: [dmg(3)],
        },
    },
);
...
const ombre = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'dague', name: 'Dague de l\'Ombre', cost: 1, desc: '3 dégâts et 1 saignement.', effects: [dmg(3), status('bleed', 1, 'same')] },
            { id: 'embuscade', name: 'Embuscade', cost: 2, desc: 'Inflige 4 dégâts.', effects: [dmg(4)] },
        ],
        utility: {
            id: 'effacement', name: 'Effacement', cost: 2,
            desc: 'Se soigne de 3 et régénération 1.',
            effects: [heal(3, 'self'), status('regen', 1, 'self', 2)],
        },
    },
);
...
const empousa = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'festin', name: 'Festin de Sang', cost: 2, desc: '4 dégâts et se soigne de 4.', effects: [dmg(4), heal(4, 'self')] },
            { id: 'saignee', name: 'Saignée', cost: 2, desc: '3 dégâts et 2 saignements.', effects: [dmg(3), status('bleed', 2, 'same')] },
        ],
        utility: {
            id: 'charme', name: 'Charme Nocturne', cost: 3,
...
const lamia = kit(
    ...
    }),
    {
        ...
        competences: [
            { id: 'rapt', name: 'Rapt', cost: 2, desc: 'L\'adversaire défausse 2 cartes.', effects: [discard(2)] },
            { id: 'etreinte', name: 'Étreinte Fatale', cost: 3, desc: 'Inflige 6 dégâts.', effects: [dmg(6)] },
        ],
        utility: {
            id: 'deuil', name: 'Deuil Éternel', cost: 2,
            desc: '3 dégâts et l\'adversaire défausse 1 carte.',
            effects: [dmg(3), discard(1)],
        },
    },
);
